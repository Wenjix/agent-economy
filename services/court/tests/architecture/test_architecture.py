"""Architecture import rule tests for the Court service.
...
class TestVisualization:
    ...
    def test_generate_module_dependency_graph(
        ...
        evaluable.visualize(
            ...
            arrows=True,
            with_labels=True,
            aliases={"court_service": "court_svc"},
        )
        ax.set_title("Court Service — Module Dependency Graph")
        fig.tight_layout()
...
class TestServicesLayerIndependence:
    ...
    def test_services_must_not_import_routers(
        ...
        (
            Rule()
            .modules_that()
            .are_sub_modules_of("court_service.services")
            .should_not()
            .import_modules_that()
    ...
    def test_services_must_not_import_middleware(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_named("court_service.core.middleware")
            .assert_applies(evaluable)
        )
...
# ---------------------------------------------------------------------------
# Module-level rules: judges layer independence
# ---------------------------------------------------------------------------


@pytest.mark.architecture
class TestJudgesLayerIndependence:
    """The judges/ layer provides LLM judge implementations.

    Must not depend on routers or app.
    """
...
class TestLeafModules:
    ...
    def test_config_must_not_import_routers(
        ...
        (
            Rule()
            .modules_that()
            .are_named("court_service.config")
            .should_not()
            .import_modules_that()
            .are_sub_modules_of("court_service.routers")
            .assert_applies(evaluable)
    ...
    def test_config_must_not_import_core(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_sub_modules_of("court_service.core")
            .assert_applies(evaluable)
        )
...
class TestRouterConstraints:
    ...
    def test_routers_must_not_import_lifespan(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_named("court_service.core.lifespan")
            .assert_applies(evaluable)
        )
