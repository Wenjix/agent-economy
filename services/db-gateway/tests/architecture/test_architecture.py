"""Architecture import rule tests for the DB Gateway service.
...
class TestVisualization:
    ...
    def test_generate_module_dependency_graph(
        ...
        evaluable.visualize(
            ...
            arrows=True,
            with_labels=True,
            aliases={"db_gateway_service": "dbgw_svc"},
        )
        ax.set_title("DB Gateway Service — Module Dependency Graph")
        fig.tight_layout()
...
class TestServicesLayerIndependence:
    ...
    def test_services_must_not_import_routers(
        ...
        (
            Rule()
            .modules_that()
            .are_sub_modules_of("db_gateway_service.services")
            .should_not()
            .import_modules_that()
            .are_sub_modules_of("db_gateway_service.routers")
    ...
    def test_services_must_not_import_app(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_named("db_gateway_service.app")
            .assert_applies(evaluable)
        )
    ...
    def test_services_must_not_import_middleware(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_named("db_gateway_service.core.middleware")
            .assert_applies(evaluable)
        )
    ...
    def test_services_must_not_import_schemas(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_named("db_gateway_service.schemas")
            .assert_applies(evaluable)
        )
...
class TestLeafModules:
    ...
    def test_config_must_not_import_routers(
        ...
        (
            Rule()
            .modules_that()
            .are_named("db_gateway_service.config")
            .should_not()
            .import_modules_that()
            .are_sub_modules_of("db_gateway_service.routers")
            .assert_applies(evaluable)
    ...
    def test_config_must_not_import_core(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_sub_modules_of("db_gateway_service.core")
            .assert_applies(evaluable)
        )
...
class TestRouterConstraints:
    ...
    def test_routers_must_not_import_lifespan(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_named("db_gateway_service.core.lifespan")
            .assert_applies(evaluable)
        )
