...
class TestVisualization:
    ...
    def test_generate_module_dependency_graph(
        ...
        evaluable.visualize(
            ...
            arrows=True,
            with_labels=True,
            aliases={"task_board_service": "tb_svc"},
        )
        ax.set_title("Task Board Service — Module Dependency Graph")
        fig.tight_layout()
...
class TestServicesLayerIndependence:
    ...
    def test_services_must_not_import_routers(
        ...
        (
            Rule()
            .modules_that()
            .are_sub_modules_of("task_board_service.services")
            .should_not()
            .import_modules_that()
    ...
    def test_services_must_not_import_middleware(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_named("task_board_service.core.middleware")
            .assert_applies(evaluable)
        )
...
# ---------------------------------------------------------------------------
# Module-level rules: clients layer independence
# ---------------------------------------------------------------------------
...
class TestLeafModules:
    ...
    def test_config_must_not_import_routers(
        ...
        (
            Rule()
            .modules_that()
            .are_named("task_board_service.config")
            .should_not()
            .import_modules_that()
            .are_sub_modules_of("task_board_service.routers")
            .assert_applies(evaluable)
    ...
    def test_config_must_not_import_core(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_sub_modules_of("task_board_service.core")
            .assert_applies(evaluable)
        )
...
class TestRouterConstraints:
    ...
    def test_routers_must_not_import_lifespan(
        ...
        (
            ...
            .should_not()
            .import_modules_that()
            .are_named("task_board_service.core.lifespan")
            .assert_applies(evaluable)
        )
